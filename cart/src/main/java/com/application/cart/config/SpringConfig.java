...
public class SpringConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/carts/cart/**").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/carts/totalQuaninty").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/carts/totalPrice").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/cartItems/**").hasAnyAuthority("ADMIN", "USER")
                .requestMatchers("/cartItems/cartItem/deleteAll").hasAnyAuthority("ADMIN", "USER")
